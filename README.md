...
| CPA base e inflação eleitoral | campos do bloco *Planejamento de mídia* |

## Nota sobre o período eleitoral

O evento acontece 8 dias antes do primeiro turno. O campo *Inflação do período eleitoral*
aplica um acréscimo sobre o CPA base e recalcula o investimento necessário. O valor gasto em
mídia não é digitado: ele é derivado do volume que você espera vender no tráfego pago,
multiplicado pelo CPA já corrigido.
